...
`03/07/2023`: We have released a [collection of scripts](src/scripts/) to create training data for TATR and to canonicalize pre-existing datasets, such as FinTabNet and SciTSR.\
