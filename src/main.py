...
def get_args():
    ...
    parser.add_argument('--data_root_dir',
                        default="/home/siddhant/PubTables-1M-Structure",
                        help="Root data directory for images and labels")
    parser.add_argument('--config_file',
                        default="structure_config.json",
    ...
    parser.add_argument('--model_load_path',default = "/home/siddhant/Downloads/pubtables1m_structure_detr_r18.pth", help="The path to trained model")
    parser.add_argument('--load_weights_only', default=True,action='store_true')
